...
import firstImg from '../FooterImages/facebook.png';
import secondImg from '../FooterImages/instagram.png';
import thirdImg from '../FooterImages/linkedin.png';
import fourthImg from '../FooterImages/twitter.png';

const Footer = (props) => {
  return (
    <div className="Footer">
		<div className="container-fluid m-y p-bt">
			<div className="row">
				<div className="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
					<div className="row">
						<div className="col-md-4 col-sm-4">
							<h2>Brainster Box</h2>
							<p>
								Brainster Box е ресурс за секој што сака да ги направи работите покреативни и 
								поефикасни во својот тим или компанија.
							</p>
						</div>
						<div className="col-md-4 col-sm-4">
							<h2>За Нас</h2>
						...
						<div className="col-md-4 col-sm-4">
							...
							<ul>
								...
								<li>
									<a href="https://www.brainster.io/akademija-za-dizajn" target="_blank" rel="noopener noreferrer">
										Академија за дизајн
									</a>
								</li>
							</ul>
			...
			<div className="row">
				<div className="col-md-12 text-right">
					<a href="https://www.facebook.com/brainster.co/" target="_blank"  rel="noopener noreferrer">
						<img src={firstImg} alt="facebook-link"/>
					</a>
					<a href="https://www.instagram.com/brainsterco/" target="_blank"  rel="noopener noreferrer">
						<img src={secondImg} alt="instagram-link"/>
					</a>
					<a href="https://www.linkedin.com/company/brainster-co" target="_blank"  rel="noopener noreferrer">
						<img src={thirdImg} alt="linkedin-link"/>
					</a>
					<a href="https://twitter.com/brainsterco" target="_blank" rel="noopener noreferrer">
						<img src={fourthImg} alt="twitter-link"/>
					</a>
				</div>
			</div>
		</div>
