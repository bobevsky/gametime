			...
			<div className="container-fluid m-y p-bt">
					...
					<div className="col-md-10 col-md-offset-1 col-sm-10 col-sm-offset-1 col-xs-10 col-xs-offset-1">
						<div className="row">
							<div className="col-md-4 col-sm-4">
								<h2>Brainster Box</h2>
								<p>
									Brainster Box е ресурс за секој што сака да ги направи
									работите покреативни и поефикасни во својот тим или компанија.
								</p>
							</div>
							<div className="col-md-4 col-sm-4">
								<h2>За Нас</h2>
								<p>
									Brainster е иновативна компанија за едукација која комбинира
									врвен наставен план , експертиза и ефективна стратегија за
									обучување на компании и индивидуалци.
								</p>
							</div>
							<div className="col-md-4 col-sm-4">
				...
				<div className="row">
					<div className="col-md-12 text-right">
						...
						>
							<img
								src={require('../assets/img/img-social/facebook.png')}
								alt="facebook-link"
							/>
						</a>
						<a
						...
						>
							<img
								src={require('../assets/img/img-social/instagram.png')}
								alt="instagram-link"
							/>
						</a>
						<a
						...
						>
							<img
								src={require('../assets/img/img-social/linkedin.png')}
								alt="linkedin-link"
							/>
						</a>
						<a
						...
						>
							<img
								src={require('../assets/img/img-social/twitter.png')}
								alt="twitter-link"
							/>
						</a>
					</div>
