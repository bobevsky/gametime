          ...
          <div className="row">
            <div className="col-md-4 col-sm-4 col-xs-4">
              <button
                ...
                className={filterNames.category.Energy ? "btn-block active" : "btn-block"}
              >
                ЕНЕРГИЈА
                <span id="Енергија">
              ...
              <button
                ...
                onClick={toggleFilters}
                className={filterNames.category.Actions ? "btn-block active" : "btn-block"}
              >
                АКЦИИ
                <span id="Акции">({games.filter((game) => game.category === "Акции").length})</span>
              </button>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4">
              <button
                ...
                onClick={toggleFilters}
                className={filterNames.category.Inovations ? "btn-block active" : "btn-block"}
              >
                ИНОВАЦИИ
                <span id="Иновации">
              ...
              >
                ТИМ
                <span id="Тим">({games.filter((game) => game.category === "Тим").length})</span>
              </button>
            </div>
            <div className="col-md-4 col-sm-4 col-xs-4">
              <button
                ...
                onClick={toggleFilters}
                className={filterNames.category.Leadership ? "btn-block active" : "btn-block"}
              >
                ЛИДЕРСТВО
                <span id="Лидерство">
              ...
              <button onClick={toggleAll} className={all ? "btn-block active" : "btn-block"}>
                СИТЕ
          ...
          <div className="row">
            <div className="col-md-6">
              <button
                ...
                onClick={toggleFilters}
                className={filterNames.time.five_thirty_min ? "btn-block active" : "btn-block"}
              >
                5-30
              </button>
              <button
                ...
                onClick={toggleFilters}
                className={
                  filterNames.time.sixty_hundredtwenty_min ? "btn-block active" : "btn-block"
                }
              >
                60-120
              </button>
            ...
            <div className="col-md-6">
              <button
                ...
                onClick={toggleFilters}
                className={filterNames.time.thirty_sixty_min ? "btn-block active" : "btn-block"}
              >
                30-60
              </button>
              <button
          ...
          <div className="row">
            ...
            <div className="col-md-4">
              <button
                ...
                onClick={toggleFilters}
                className={filterNames.players.ten_fourty ? "btn-block active" : "btn-block"}
              >
                10-40
              </button>
            </div>
